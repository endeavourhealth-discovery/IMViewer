...
// import Templates from "../../../models/modules/Templates";
...
export default defineComponent({
  ...
  methods: {
    ...
    matchLabel(clause: any): string {
      ...
      let _entityType = clause.json.entityType ? clause.json.entityType["http://www.w3.org/2000/01/rdf-schema#label"] : "";
      let _property = clause.json.property ? clause.json.property["http://www.w3.org/2000/01/rdf-schema#label"] : "";
      ...
      return _entityType || _property || (clause?.json?.property ? toName(clause.json.property["@id"]) : toName(clause.json.entityType["@id"]));
    },
