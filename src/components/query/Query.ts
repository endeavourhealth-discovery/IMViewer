...
class Entity {
    ...
    constructor(entity: any) {
        ...
        this["http://www.w3.org/1999/02/22-rdf-syntax-ns#type"] = entity["http://www.w3.org/1999/02/22-rdf-syntax-ns#type"] ? entity["http://www.w3.org/1999/02/22-rdf-syntax-ns#type"] as Entity : null;
        this["http://www.w3.org/2000/01/rdf-schema#label"] = entity["http://www.w3.org/2000/01/rdf-schema#label"] ? entity["http://www.w3.org/2000/01/rdf-schema#label"] : "";
        this["http://www.w3.org/2000/01/rdf-schema#comment"] = entity["http://www.w3.org/2000/01/rdf-schema#comment"] ? entity["http://www.w3.org/2000/01/rdf-schema#comment"] : "";
        this["http://endhealth.info/im#isContainedIn"] = entity["http://endhealth.info/im#isContainedIn"] ? entity["http://endhealth.info/im#isContainedIn"] as Entity : null;
        return this;
    }
}
...
export class Profile extends Entity {
    ...
    get mainEntity(): any {
        ...
        // const _id = this["http://endhealth.info/im#definition"]["entityType"]["@id"];

        // const _name = this["http://endhealth.info/im#definition"]["entityType"]["http://www.w3.org/2000/01/rdf-schema#label"]
        //     ? this["http://endhealth.info/im#definition"]["entityType"]["http://www.w3.org/2000/01/rdf-schema#label"]
        //     : this["http://endhealth.info/im#definition"]["entityType"]["@id"].split("#")[1];

        // const _entityType = this["http://endhealth.info/im#definition"]["entityType"]["http://www.w3.org/1999/02/22-rdf-syntax-ns#type"]
        //     ? this["http://endhealth.info/im#definition"]["entityType"]["http://www.w3.org/1999/02/22-rdf-syntax-ns#type"]
