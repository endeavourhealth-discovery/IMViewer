...
const tabMap = reactive(new Map<string, number>());
const editDialogView = ref(true);
const showDownloadDialog = ref(false);
const concept: Ref = ref({});
...
const definitionConfig: Ref<DefinitionConfig[]> = ref([]);
const summaryConfig: Ref<DefinitionConfig[]> = ref([]);
const conceptAsString = ref("");
const terms: Ref<any[]> = ref([]);
const selectedOption: Ref = ref({});
const splitterRightSize = ref(0);
const dataSet: Ref = ref({});
